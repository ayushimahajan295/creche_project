...
const About = () => {
  return (
    <div className='flex flex-col items-center my-10'>
      {/* About Section */}
      <div className='flex flex-col justify-center gap-6 text-gray-600 text-center md:w-2/4'>
        ...
        <p>At Caring Nannies, our mission is to empower families by providing reliable and compassionate childcare solutions. We strive to create lasting relationships between families and nannies, ensuring peace of mind for parents and a safe, loving environment for children.</p>
      </div>
